              ...
              {categories.length === 0 ? (
                ...
                <>
                  <div className="grid md:grid-cols-3 gap-8 mb-6">
                    ...
                    {/* Spare Parts Store Entry Card */}
                    <div
                      onClick={() => navigate('/store/categories')}
                      className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border-2 border-amber-300 p-8 flex flex-col items-center cursor-pointer hover:shadow-lg hover:border-amber-400 transition-all group relative"
                    >
                      <div className="text-6xl mb-4 group-hover:scale-110 transition-transform">
                        🛠️
                      </div>
                      <h3 className="text-xl font-semibold text-amber-900 mb-2">Spare Parts Store</h3>
                      <p className="text-sm text-amber-700 text-center mb-4">Shop genuine replacement parts</p>
                      <button className="w-10 h-10 rounded-full bg-amber-600 text-white flex items-center justify-center hover:bg-amber-700 transition">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </button>
